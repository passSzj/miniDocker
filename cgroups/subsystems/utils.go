...
func findCgroupMountpoint(subsystem string) string {
	...
	// 通过 cat /proc/self/mountinfo 命令查看
	...
	for scanner.Scan() {
		// txt 大致内容 /sys/fs/cgroup/memory rw,nosuid,nodev,noexec,relatime - cgroup cgroup rw,memory
		txt := scanner.Text()
		// 然后按照空格分割
